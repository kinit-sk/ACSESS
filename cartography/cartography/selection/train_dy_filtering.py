...
if __name__ == "__main__":
  ...
  parser.add_argument("--task_name",
                      "-t",
                      default="WINOGRANDE",
                      # choices=("SNLI", "MNLI", "QNLI", "WINOGRANDE", "DOG", "APL", "AWA", "ACT_410", "TEX_DTD", "PRT", "PNU", "FLW"),
  ...
  for task_name in ['20News', 'NewsCategory', 'atis', 'facebook', 'liu', 'snips']:
    for repeat in range(10):

      args.task_name = task_name
      args.model_dir = f'{task_name}_{repeat}'
      args.model = 'BERT'
      ...
      if args.plot:
        ...
        plot_data_map(train_dy_metrics, args.model_dir, title=args.task_name, show_hist=True, model=args.model)
