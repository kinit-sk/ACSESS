...
if __name__ == '__main__':
    ...
    for repeat in range(10):
        channel, im_size, num_classes, class_names, mean, std, dst_train, dst_u_all, dst_test = datasets.__dict__[args.dataset](args, args.resolution)
        ...
        dst_subset = CustomSubset(dst_train, labeled_set)
