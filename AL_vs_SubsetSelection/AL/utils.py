...
def get_model(args, nets, model, pretrained):
    network = nets.__dict__[model](args.channel, args.num_classes, args.im_size, pretrained=pretrained).to(args.device)
...
def get_text_model(args, model):
    network = TextTransformer(model, args.num_classes)
