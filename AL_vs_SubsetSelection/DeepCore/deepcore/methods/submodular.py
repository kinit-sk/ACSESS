...
class Submodular(EarlyTrain):
    ...
    def finish_run(self):
        ...
        with self.model.embedding_recorder:
            ...
            if self.balance:
                ...
                for c in range(self.num_classes):
                    ...
                    budget=self.fraction if self.fraction > 1 else round(self.fraction * len(c_indx))
                    ...
                    submod_optimizer = submodular_optimizer.__dict__[self._greedy](args=self.args, index=c_indx, budget=budget, already_selected=[])
        ...
        return {"indices": selection_result, "scores": np.ones(selection_result.shape)}
