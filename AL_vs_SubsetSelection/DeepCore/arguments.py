...
parser.add_argument('--core-model', type=str, default='TextTransformer', help='core-model')
# parser.add_argument('--model', type=str, default='ResNet18', help='model')
parser.add_argument('--model', type=str, default='TextTransformer', help='model')
parser.add_argument('--pretrained', default=False, type=str_to_bool, help="whether to use pretrained network")
...
parser.add_argument('--strategy', type=str, default="basic", help="strategy used for creating training data")
