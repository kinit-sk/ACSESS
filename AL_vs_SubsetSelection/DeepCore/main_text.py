...
def main():
    ...
    for exp in range(start_exp, args.num_exp):
        ...
        num_classes, class_names, dst_train, dst_test = datasets.__dict__[args.dataset](args, tokenizer, MAX_LEN)
        args.num_classes, args.class_names = num_classes, class_names
        args.im_size = (224, 224)
        seeds = [42, 1337, 15435, 43543435, 2154864, 345433434, 5435434, 545454, 56878942, 6843531]
