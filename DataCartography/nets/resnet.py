...
def ResNet(arch: str, channel: int, num_classes: int, im_size, record_embedding: bool = False, no_grad: bool = False,
    ...
    arch = arch.lower()
    if pretrained:
        print('Running pretrained network!')
        ...
        # state_dict = load_state_dict_from_url('https://s3.amazonaws.com/pytorch/models/resnet18-5c106cde.pth', progress=True)
        ...
        print('Running 32 network!')
        net = ResNet_32x32(BasicBlock, [2, 2, 2, 2], channel=channel, num_classes=num_classes, record_embedding=record_embedding, no_grad=no_grad, penultimate=penultimate)
    else:
